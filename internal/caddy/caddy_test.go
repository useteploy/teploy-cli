...
func TestSetRoute_WritesBlockAndReloads(t *testing.T) {
	...
	if err := client.SetRoute(context.Background(), "myapp", "myapp.com", "myapp-v1", 80, TLS{}, "", Firewall{}); err != nil {
...
func TestSetRoute_UpdateExisting(t *testing.T) {
	...
	client := NewClient(mock)
	if err := client.SetRoute(context.Background(), "myapp", "myapp.com", "myapp-v2", 3000, TLS{}, "", Firewall{}); err != nil {
		t.Fatalf("SetRoute: %v", err)
	}
...
func TestSetRoute_AdoptsForeignBlock(t *testing.T) {
	...
	client := NewClient(mock)
	if err := client.SetRoute(context.Background(), "myapp", "myapp.com, www.myapp.com", "myapp-v1", 80, TLS{}, "", Firewall{}); err != nil {
		t.Fatalf("SetRoute: %v", err)
	}
...
func TestSetRoute_ReloadFailureRollsBack(t *testing.T) {
	...
	client := NewClient(mock)
	err := client.SetRoute(context.Background(), "myapp", "myapp.com", "myapp-v1", 80, TLS{}, "", Firewall{})
	if err == nil {
...
func TestSetLoadBalancer(t *testing.T) {
	...
	if err := client.SetLoadBalancer(context.Background(), "myapp", "myapp.com", upstreams, TLS{}, "", Firewall{}); err != nil {
...
func TestSetRoute_WithCaddyExtra(t *testing.T) {
	...
	if err := client.SetRoute(context.Background(), "myapp", "myapp.com", "myapp-v1", 80, TLS{}, extra, Firewall{}); err != nil {
		t.Fatalf("SetRoute: %v", err)
	}
	got := string(mock.Files[tmpCaddyfile])
	for _, want := range []string{
...
func TestSetLoadBalancer_WithCaddyExtra(t *testing.T) {
	...
	if err := client.SetLoadBalancer(context.Background(), "myapp", "myapp.com", upstreams, TLS{}, extra, Firewall{}); err != nil {
		t.Fatalf("SetLoadBalancer: %v", err)
	}
	got := string(mock.Files[tmpCaddyfile])
	for _, want := range []string{
...
func TestReverseProxyBlock(t *testing.T) {
	got := reverseProxyBlock([]string{"example.com"}, "myapp-v1", 8080, TLS{}, "", Firewall{})
...
func TestReverseProxyBlockMultiHost(t *testing.T) {
	got := reverseProxyBlock([]string{"example.com", "www.example.com"}, "myapp", 80, TLS{}, "", Firewall{})
...
func TestLoadBalancerBlock(t *testing.T) {
	got := loadBalancerBlock([]string{"example.com"}, []Upstream{{Dial: "a:80"}, {Dial: "b:80"}}, TLS{}, "", Firewall{})
...
func TestReverseProxyBlock_WithTLS(t *testing.T) {
	got := reverseProxyBlock([]string{"fylun.ai"}, "fylun-web-v1", 3000,
		TLS{Cert: "/etc/caddy/tls/fylun-web.crt", Key: "/etc/caddy/tls/fylun-web.key"}, "", Firewall{})
...
func TestReverseProxyBlock_NonPublicDomainGetsPlainHTTP(t *testing.T) {
	got := reverseProxyBlock([]string{"192.168.1.114"}, "investment-club-v1", 3000, TLS{}, "", Firewall{})
...
func TestReverseProxyBlock_TLSInternalKeepsRealHost(t *testing.T) {
	got := reverseProxyBlock([]string{"192.168.1.114"}, "myapp-v1", 3000, TLS{Internal: true}, "", Firewall{})
...
func TestReverseProxyBlock_CustomCertKeepsRealHost(t *testing.T) {
	got := reverseProxyBlock([]string{"192.168.1.114"}, "myapp-v1", 3000,
		TLS{Cert: "/etc/caddy/tls/myapp.crt", Key: "/etc/caddy/tls/myapp.key"}, "", Firewall{})
